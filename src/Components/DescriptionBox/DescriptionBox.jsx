    ...
    return (
        <div>
            <div className="container descriptionBox ">
                <div className="row">
                    <p>Made for</p> <p className='text-black-50'>Made for hiking in the cold - weather. This fleece is made up of Recycled Polyester and keeps you warm up to 10 degrees when used as the second layer.</p>
                </div>
